...
import { Book, Globe, Menu, Search } from "lucide-react";
        ...
        <div className="container mx-auto flex items-center justify-between py-4">
          ...
          <div className="flex-1 mx-6 flex justify-center">
            {!scrolled ? (
              ...
              <div
                className="hidden md:flex border rounded-full shadow-sm bg-gray-100 overflow-hidden transition-all duration-300 items-center"
                style={{ width: `${totalMenuWidth}px` }}
              >
                {/* Anywhere */}
                <div className="flex-1 text-center py-2 cursor-pointer hover:bg-white transition-colors flex items-center justify-center gap-2">
                  {selectedMenu?.icon && (
                    <img
                ...
                {/* Check in */}
                <div className="flex-1 text-center py-2 cursor-pointer hover:bg-white transition-colors">
                  <div className="text-xs text-gray-600 font-semibold">
                    Check in
                  </div>
                ...
                {/* Guests + Search */}
                <div className="flex-1 flex justify-between items-center px-2 py-2 cursor-pointer hover:bg-white transition-colors">
                  <div>
                    <div className="text-xs text-gray-600 font-semibold">
                      Guests
                    </div>
                    <div className="text-sm font-medium">Add guests</div>
                  </div>
    ...
    >
      ...
      >
        ...
        <input
          ...
          className="w-full text-sm text-gray-500 bg-transparent outline-none mt-1"
