...
export default function SeoulPage() {
  const [products, setProducts] = useState<Seoul[]>([]);
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const data: Seoul[] = await res.json();
        setProducts(data);
        setLoading(false);
      } catch (err) {
        console.error(err);
    ...
    return (
      <div className="px-5 pt-5">
        <div className="flex justify-between items-center">
          <h1 className="text-base lg:text-xl font-bold mt-6">Homes in Seoul</h1>
  ...
  return (
    <div className="px-5">
      <div className="flex justify-between items-center">
        <h1 className="text-base lg:text-lg font-bold mb-2 lg:mt-6">Homes in Seoul</h1>
          ...
          >
            <div className="relative">
              <img
                ...
                className="w-full h-40 md:h-52 lg:h-64 object-cover rounded-3xl"
              />
