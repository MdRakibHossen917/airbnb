...
export default function ChefsPage() {
  const [products, setProducts] = useState<Chefs[]>([]);
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const data: Chefs[] = await res.json();
        setProducts(data);
        setLoading(false);
      } catch (err) {
        console.error(err);
    ...
    return (
      <div className="px-5">
        <div className="flex justify-between items-center">
          <h1 className="text-base lg:text-xl font-bold mt-6">Chefs</h1>
  ...
  return (
    <div className="px-5">
      <div className="flex justify-between items-center">
        <h1 className="text-base lg:text-xl font-bold text-gray-800 lg:mt-6">
          Chefs
        </h1>
        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="p-2 text-xs">
              ...
              <p className="text-gray-600 mb-1 truncate">{product.extra}</p>
