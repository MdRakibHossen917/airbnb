...
if (loading) {
  ...
  return (
    <div className="px-5">
        <h1 className="text-3xl font-bold text-gray-800 my-4">Popular with travelers from your area</h1>
      <div className="flex justify-between items-center">
        <h1 className="text-xl font-bold text-gray-800">Experiences in Kuala Lumpur</h1>
