...
export default function TokyoPage() {
  const [products, setProducts] = useState<Tokyo[]>([]);
...
if (loading) {
  return (
    <div className="px-5 pt-5 mt-44">
      <div className="flex justify-between items-center">
        <h1 className="text-xl font-bold mt-6">Places to stay in Tokyo</h1>
  ...
  return (
    <div className="px-5">
      <div className="flex justify-between items-center">
        <h1 className="text-base lg:text-xl font-bold">Places to stay in Tokyo</h1>
