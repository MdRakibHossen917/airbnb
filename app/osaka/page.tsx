...
export default function OsakaPage() {
    ...
    return (
      <div className="px-5 pt-5">
        <div className="flex justify-between items-center">
          <h1 className="text-base lg:text-xl font-bold mt-6">Available next month in Osaka</h1>
  ...
  return (
    <div className="px-5">
      <div className="flex justify-between items-center">
        <h1 className="text-base lg:text-lg font-bold mb-2 lg:mt-6">Available next month in Osaka</h1>
