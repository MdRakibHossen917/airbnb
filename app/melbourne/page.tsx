...
export default function MelbournePage() {
  const [products, setProducts] = useState<Melbourne[]>([]);
...
if (loading) {
  return (
    <div className="px-5 pt-5 mt-44">
      <div className="flex justify-between items-center">
        <h1 className="text-xl font-bold mt-6">Check out homes in Melbourne</h1>
  ...
  return (
    <div className="px-5">
      <div className="flex justify-between items-center">
        <h1 className="text-base lg:text-xl font-bold">Check out homes in Melbourne</h1>
